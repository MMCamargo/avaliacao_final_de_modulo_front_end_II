...
function validateRegister(name: HTMLInputElement, email: HTMLInputElement, password: HTMLInputElement, repassword: HTMLInputElement): boolean {
    ...
    if (usersList.some((userEmail: User) => userEmail.email === email.value)) {
...
function submitRegister(name: HTMLInputElement, email: HTMLInputElement, password: HTMLInputElement): void {
...
function showAlertRegister(color: string, msg: string): void {
